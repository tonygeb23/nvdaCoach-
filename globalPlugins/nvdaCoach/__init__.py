...
class CoachWindow(wx.Frame):
	...
	def _buildUI(self):
		...
		self._instructionText.SetValue(
			...
			"=== STOP NVDA AT ANY TIME: READ THIS FIRST ===\n"
			"The Ctrl key (bottom-left corner of your keyboard, labeled Ctrl) "
			"silences NVDA instantly, any time it is speaking.\n"
			"Press Ctrl once  =  NVDA stops talking. That is it.\n"
			"Use it any time NVDA reads too fast, goes on too long, "
			"or you simply need a moment of quiet.\n"
			"This is the single most important key you will learn as an NVDA user. "
			"You will reach for it dozens of times every day.\n\n"
			"--- ABOUT THIS PROGRAM ---\n"
			"NVDA Coach teaches screen reader commands through short, hands-on drills. "
			"It is designed for beginners who already have a basic feel for their keyboard "
			"(letters, numbers, arrow keys, Enter, Escape, Tab). "
			"If you are not yet confident on your keyboard, that is completely fine. "
			"NVDA's built-in Input Help tool is here for you: "
			"press NVDA+1 to turn it on, then press any key to hear what it does "
			"without anything actually happening. Press NVDA+1 again to turn it off. "
			"Use it any time you need to explore safely.\n\n"
			...
			"questions before you dive in. If you are learning on your own, that is "
			"completely okay too. NVDA Coach is built to guide you independently, "
			"step by step, at your own pace. You do not need anyone else in the room "
			"to make real progress. Trust the process and trust yourself.\n\n"
			"--- HOW TO NAVIGATE ---\n"
			"  Press NVDA+Shift+C to open the lesson picker and start a lesson.\n"
			...
			"  Escape \u00d7 3  \u2014  Close this window.\n\n"
			"When you are ready, press NVDA+Shift+C to open the lesson picker."
		)
	...
	def showIntroduction(self):
		...
		introText = (
			...
			"This is the single most important key you will learn as an NVDA user. "
			"You will reach for it dozens of times every day. "
			"It works everywhere, in every program, at any moment.\n\n"
			"--- ABOUT THIS PROGRAM ---\n"
			"NVDA Coach teaches screen reader commands through short, hands-on drills. "
			"It is designed for beginners who already have a basic feel for their keyboard "
			"(letters, numbers, arrow keys, Enter, Escape, Tab). "
			...
			"press NVDA+1 to turn it on, then press any key to hear what it does "
			"without anything actually happening. Press NVDA+1 again to turn it off. "
			"You can use NVDA+1 at any time, even while a lesson is running.\n\n"
			"--- WORKING WITH AN INSTRUCTOR? ---\n"
			"If you have an assistive technology instructor nearby, let them know you are "
			"starting NVDA Coach. They can help you find keys, adjust settings, or answer "
			"questions before you dive in. If you are learning on your own, that is "
